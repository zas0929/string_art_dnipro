...
5. Режим v5 дополнительно оценивает изображение на масштабах `560`, `280` и `140` пикселей, периодически проверяет пару следующих линий, использует откалиброванный по эталонной схеме баланс маршрута и субпиксельную модель реальной толщины нити.
