const COMMAND_PHRASES = {
  uk: {
    play: ["старт", "почати", "продовжити", "продовжуй", "запускай", "начать", "продолжить", "поехали"],
    pause: ["пауза", "стоп", "зупини", "зупинити", "остановить", "бля", "блин"],
    next: ["далі", "наступна", "наступний", "вперед", "дальше", "следующий"],
    previous: ["назад", "попередня", "попередній", "предыдущий"],
